...
export function isStateUpdated(message: unknown): message is { type: "stateUpdated"; state: OutlineState } {
  return Boolean(
    message &&
...
export function isHistoryStatus(message: unknown): message is { type: "historyStatus" } & HistoryStatus {
  return Boolean(
    message &&
      typeof message === "object" &&
