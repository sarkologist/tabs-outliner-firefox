...
- continue rename/editing state transitions crossing search, clear-search, and show-in-tree owner replacement, now including stale outline refills before the current search response;
