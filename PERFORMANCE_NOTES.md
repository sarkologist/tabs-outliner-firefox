...
- **Guards:** full vitest 776 (+4), typecheck (src + test) + build clean, `perf-runtime-guard --hard-only` PASS (9, counters unchanged), `perf:sidebar-projection-guard` PASS (2), storage-fault lane PASS (corpus + crash soak).
