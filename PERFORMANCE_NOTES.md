...
- Profile results after `pnpm run build`:
  - `pnpm profile:tab-open -- --tabs 50000 --scenario startup-initial-snapshot`: 1ms initial snapshot, 256 rows/nodes, 424ms full v2 hydration, 0 saves/broadcasts.
  ...
  - `pnpm profile:tab-open -- --tabs 50000 --updates 5 --scenario new-window-storm`: 25ms perceived, 163ms with save flush, 13 MB stringified.
