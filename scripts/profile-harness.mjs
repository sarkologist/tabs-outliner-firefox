...
export function createProfileEvents() {
  ...
  return {
    ...
    events: {
      ...
      tabDetached: new FakeEvent("tabs.onDetached", eventCounts),
      tabAttached: new FakeEvent("tabs.onAttached", eventCounts),
      tabMoved: new FakeEvent("tabs.onMoved", eventCounts),
...
export async function flushProfileEvents(events) {
  await Promise.all([
    ...
    events.tabDetached.flush(),
    events.tabAttached.flush(),
    events.tabMoved.flush(),
